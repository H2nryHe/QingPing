...
# credit to https://blog.csdn.net/footless_bird/article/details/132954702
...
# print(df.head())
df = pd.DataFrame(res['data']['plate_list'])
df = df.rename(columns={'code': '概念代码', 'name': '概念名称'})
print(df.head())
df.to_csv('hot_list_data_8_27.csv', index=False, encoding='utf-8')
